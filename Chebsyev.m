...
N = 4;                      %Calculted manually in the calculations
...
n1 = [1 -p1-p2 p1*p2];              %Coefficients of quadratic with roots p1, p2
n2 = [1 -p3-p4 p3*p4];              %Coefficients of quadratic with roots p3, p4
...
%Band Edge specifications given to us in form of BL and BH
fs1 = 58.3;
fp1 = 62.3;
fp2 = 82.3;
fs2 = 86.3;
...
%Parameters for Bandpass Transformation for bandpass to lowpass
W0 = sqrt(wp1*wp2);
B = wp2-wp1;
